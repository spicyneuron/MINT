...
\begin{table}[h]
\centering
\caption{Qwen3.5-35B-A3B scaling: perplexity and MMLU across budget levels. MINT beats uniform 4-bit in both PPL and MMLU at only 3\% more storage. MMLU improves through 37\,GB ($+1.5$ pp) then saturates, while PPL continues to narrow the gap to BF16. The 21\,GB MMLU result was confirmed by independent rerun (70.22\% both times). Full bit distributions are in Appendix~\ref{app:qwen35_full}.}
...
\textbf{MINT 21\,GB} & \textbf{21\,GB} & \textbf{4.5} & \textbf{6.713} & \textbf{6.630} & \textbf{70.22\%} \\
MINT 30\,GB & 30\,GB & 6.5 & 6.627 & 6.535 & 70.91\% \\
...
MINT's mixed-precision allocation assigns varying bit-widths and group sizes per tensor, which can affect inference throughput relative to uniform quantization. Table~\ref{tab:throughput} measures the impact.
...
MINT 30\,GB & 30\,GB & 6.5 & 6.627 & 6.535 & 70.91\% & --- & 54\% & 38\% & 8\% \\
